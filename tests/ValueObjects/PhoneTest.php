...
final class PhoneTest extends TestCase {
  #[Test]
  #[DataProvider('validPhones')]public function accept_valid_phones(string $phone, string $expected): void {
    $phone = new Phone($phone);

    $this->assertSame($phone->__toString(), $expected);
  }

  #[Test]
  #[DataProvider('invalidPhones')]public function throws_exception_for_invalid_phones(string $invalidPhone): void {
