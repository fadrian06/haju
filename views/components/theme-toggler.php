<li class="dropdown">
  <button
    ...
    <svg
      ...
      height="1em"
      class="my-1">
      <use :href="`#${theme === 'light' ? 'sun-fill' : 'moon-stars-fill'}`"></use>
    </svg>
  </button>
  <menu class="dropdown-menu dropdown-menu-end py-0">
    <button
      :class="`dropdown-item d-flex align-items-center p-3 ${theme === 'light' && 'active'}`"
    ...
    <button
      :class="`dropdown-item d-flex align-items-center p-3 ${theme === 'dark' && 'active'}`"
      @click="setTheme('dark')">
      <svg
        fill="currentColor"
        width="1em"
