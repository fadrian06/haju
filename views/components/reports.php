...
<ul class="list-unstyled row row-cols-sm-2 row-cols-md-3">
  <li class="mb-4 d-flex">
    <article class="card card-body text-center justify-content-between">
      <div>
        <picture class="p-3 pt-1 text-success w-50 mx-auto display-1" data-bs-toggle="tooltip" title="Sistema de Información para la Salud ~ Epidemiología">
          <svg viewBox="0 0 24 24" width="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <li class="mb-4 d-flex align-items-stretch">
    <article class="card card-body text-center justify-content-between">
      <div>
        <picture
          class="p-3 pt-1 text-success w-50 mx-auto display-1"
          data-bs-toggle="tooltip"
          title="Sistema de Información para la Salud ~ Epidemiología">
          <svg viewBox="0 0 460 460" width="1em" xml:space="preserve">
            <g>
